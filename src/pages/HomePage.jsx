...
const HomePage = () => {
  ...
  return (
    <motion.div initial="hidden" animate="visible" exit={{ opacity: 0 }} variants={containerVariants} className="space-y-20 md:space-y-28 pb-16">
      <section className="relative min-h-[85vh] flex items-center pt-20 pb-24 overflow-hidden">
        {/* Background Image & Overlay */}
        <div className="absolute inset-0 z-0">
          <img 
            alt="panoramic view from skyscraper window with city skyline at sunset, person on balcony, EVERY HOME WILL BECOME A SMART HOME text and LifeSmart logo" 
            className="w-full h-full object-cover" 
            src="https://horizons-cdn.hostinger.com/399f02cf-d238-442b-8230-bd06d51cc905/abc784a0c2890aa3a2ca7900bac8824d.png" 
          />
          <div className="absolute inset-0 bg-gradient-to-r from-background/95 via-background/80 to-transparent dark:from-background/95 dark:via-background/80 dark:to-transparent"></div>
          <div className="absolute inset-0 bg-black/30 md:hidden"></div>
        </div>

        {/* Hero Content */}
        <div className="container mx-auto px-4 relative z-10">
          <motion.div variants={containerVariants} className="max-w-2xl text-left">
            <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-7xl font-extrabold mb-6 text-foreground leading-tight drop-shadow-md">
              El futuro de tu hogar, <span className="text-primary">hoy</span>.
            </motion.h1>
            <motion.p variants={itemVariants} className="text-lg md:text-xl text-foreground/90 max-w-xl mb-10 drop-shadow font-medium">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-start">
              ...
              <Button asChild variant="outline" size="lg" className="border-primary text-primary bg-background/20 backdrop-blur-md hover:bg-primary/20 hover:text-primary transition-all duration-300 px-8 py-6 text-lg rounded-full">
                <Link to="/servicios">
                  Ver Servicios
                </Link>
              </Button>
      ...
      <section className="py-16 md:py-20 bg-muted/20 backdrop-blur-sm border border-white/5 rounded-2xl mx-4 lg:mx-auto max-w-7xl">
        <div className="container mx-auto px-4 py-8 md:py-12">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <motion.div className="relative h-64 md:h-80 w-full order-last md:order-first" initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.7 }} className="md:pr-8">
      ...
      <section className="py-16 md:py-20 container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7 }} className="text-center mb-12 md:mb-16">
      ...
      <section className="py-12 md:py-16 bg-muted/20 backdrop-blur-sm border border-white/5 rounded-2xl mx-4 lg:mx-auto max-w-7xl">
      ...
      <section className="py-16 md:py-20 bg-muted/40 border border-white/5 rounded-2xl mx-4 lg:mx-auto max-w-7xl">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.7 }}>
