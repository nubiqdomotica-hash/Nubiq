  ...
  const services = [
    {
      ...
      imageUrl: '/secciones/iluminacion.webp',
      imageAlt: 'Living de noche con iluminación inteligente cálida y ambiental',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/secciones/climatizacion.webp',
      imageAlt: 'Mujer ajustando un termostato inteligente en la pared de su casa',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/secciones/persianas-cortinas.webp',
      imageAlt: 'Living premium y luminoso con cortinas roller en un gran ventanal regulando la luz natural',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/secciones/seguridad-acceso.webp',
      imageAlt: 'Cerradura inteligente con teclado numérico en una puerta de madera',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/secciones/vigilancia.webp',
      imageAlt: 'Cámaras de seguridad para la vigilancia inteligente del hogar',
      features: [
    ...
    },
    {
      ...
      imageUrl: '/secciones/pileta-riego.webp',
      imageAlt: 'Jardín con pileta y sistema de riego automatizado',
      features: [
